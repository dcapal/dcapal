...
export default function AboutPage() {
  return (
    <div className="w-full h-screen flex flex-col items-center">
      ...
      <div
        id="social-profiles"
        className="w-full max-w-[44rem] p-6 flex flex-col items-center gap-6"
      >
        <div className="w-full flex flex-col gap-4 text-justify font-thin text-lg">
          ...
          <p>
            I was facing a common problem: it's that time of the month, got some
            savings to invest and have to split them across my portfolio assets.{" "}
          ...
          <p>
            ...
            portfolio, define asset allocation in percentage, input how much you
            want to invest and{" "}
        ...
        >
          ...
          <p>
            Since DcaPal is a zero-login service, we don't do user profiling. We
            do not store any user data: portfolio assets, invested amounts,
        ...
        <div
          ...
          className="w-full flex flex-col gap-2 text-justify font-thin text-lg"
        >
          <h2 className="w-full text-3xl font-semibold mt-4 mb-2">Feedback</h2>
          <p>
            If you find any issue, would like to ask for new features or simply
            leave a feedback,{" "}
            <span className="font-normal">feel free to reach out</span> to me on
            any of{" "}
          ...
          <p>
            ...
            <span className="align-super">
              {" "}
              DcaPal on Github if you like it or drop me an{" "}
            </span>
            <GitHubButton
