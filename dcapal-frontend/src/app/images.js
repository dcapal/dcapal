...
export const ICON_REBALANCE_SVG = "icons/market.svg";
export const ICON_PORTFOLIO_SVG = "icons/portfolio.svg";
...
export const SOCIAL_GITHUB_SVG = "social/github.svg";
export const SOCIAL_YOUTUBE_SVG = "social/youtube.svg";
export const SOCIAL_MAIL_SVG = "social/mail.svg";
export const SOCIAL_TELEGRAM_SVG = "social/telegram.svg";
